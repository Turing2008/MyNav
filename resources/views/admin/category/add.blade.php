        ...
        <div class="layui-row">
            <form class="layui-form" action="" lay-filter="example" onsubmit="return false;">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="number" name="Category[sort]" value="{{$category->sort ?? 99}}" maxlength="100"
                               autocomplete="off"
                               placeholder=""
                               class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="Category[flag]" value="1" title="是">
                        <input type="radio" name="Category[flag]" value="0" title="否" checked>
                    </div>
                </div>
